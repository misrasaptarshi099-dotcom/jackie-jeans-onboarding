...
export default function LandingPage() {
  ...
  return (
    <div className="bg-background min-h-screen">
      ...
      {/* OUTRO */}
      <section className="w-full bg-[#0a0a0a] pt-24 pb-12 flex flex-col items-center justify-center border-t border-white/5 relative overflow-hidden">
        <div className="w-full flex justify-center mb-16 relative z-20">
          <a 
            href="https://github.com/misrasaptarshi099-dotcom/jackie-jeans-onboarding" 
            target="_blank" 
            rel="noopener noreferrer"
            className="flex items-center gap-3 text-white/40 hover:text-primary transition-all duration-300 font-body text-xs tracking-[0.2em] uppercase group"
          >
        ...
        <div className="w-full w-max-full overflow-hidden text-center select-none flex items-center justify-center relative z-10 px-4">
          <motion.h2 
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 1.2, ease: "easeOut" }}
            viewport={{ once: true }}
            className="font-display font-bold text-transparent bg-clip-text bg-gradient-to-b from-[#e5c487]/80 to-[#4a3a1f]/20" 
            style={{ fontSize: 'clamp(4rem, 16vw, 24rem)', lineHeight: 0.8, letterSpacing: '-0.04em' }}
          >
            JACKIE FIT
          </motion.h2>
        </div>
